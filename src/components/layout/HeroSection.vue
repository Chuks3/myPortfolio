        ...
        <main class="absolute grid lg:grid-cols-2 grid-cols-1 items-center p-2 lg:p-8">
            <header class="text-center lg:text-left">
                <h1 class="mb-6 text-4xl md:text-5xl lg:text-6xl font-bold">
                    🙋‍♂️ Hi I'm <span class="text-primary stroke-text dark:text-secondary">Chuks</span>
                </h1>
                <p class="text-lg max-w-xl mx-auto lg:mx-0 font-semibold">
                    A web developer and designer focused on building clean, efficient, and user-friendly websites. I
            ...
            <aside class="container flex justify-center lg:justify-end mt-20 lg:mt-0 items-center flex-wrap">
                <figure
                    class="card relative m-[30px] md:w-[420px] md:h-[420px] md:before:w-[450px] md:before:h-[450px] w-[280px] h-[350px] before:w-[300px] before:h-[300px] before:border-[25px] before:border-primary before:shadow-[7px_7px_21px_secondary,_-7px_-7px_21px_secondary] dark:before:border-secondary dark:before:shadow-[7px_7px_21px_secondary,_-7px_-7px_21px_secondary]">
                    <div class="relative w-full h-full bg-cover transform translate-x-[10px] translate-y-[10px]">
                        <img src="@/assets/images/hero.png" alt="Hero picture" class="w-full h-full object-cover"
                            loading="lazy">
                    </div>
                </figure>
            </aside>
